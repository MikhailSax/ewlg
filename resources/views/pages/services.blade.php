...
<div class="container py-14">
  ...
  <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
    <article class="border rounded p-4"><h2 class="font-semibold text-[#1C1F35]">Автоперевозки</h2><p class="mt-2 text-sm">FTL и LTL-перевозки с контролем температуры и сроков.</p><a href="{{ route('service.single') }}" class="text-[#091242] mt-3 inline-block">Подробнее</a></article>
    ...
    <article class="border rounded p-4"><h2 class="font-semibold text-[#1C1F35]">Морская доставка</h2><p class="mt-2 text-sm">FCL/LCL из Азии, Ближнего Востока и Европы.</p><a href="{{ route('service.single') }}" class="text-[#091242] mt-3 inline-block">Подробнее</a></article>
    <article class="border rounded p-4"><h2 class="font-semibold text-[#1C1F35]">Железнодорожная доставка</h2><p class="mt-2 text-sm">Стабильные сроки для регулярных поставок из Китая.</p><a href="{{ route('service.single') }}" class="text-[#091242] mt-3 inline-block">Подробнее</a></article>
    <article class="border rounded p-4"><h2 class="font-semibold text-[#1C1F35]">Карго доставка</h2><p class="mt-2 text-sm">Комплексная доставка «под ключ» для малого и среднего бизнеса.</p><a href="{{ route('service.single') }}" class="text-[#091242] mt-3 inline-block">Подробнее</a></article>
